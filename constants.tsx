...
const H2: React.FC<{ children: React.ReactNode }> = ({ children }) => <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-800 border-b pb-2">{children}</h2>;
const H3: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => <h3 className={`text-xl font-semibold mt-6 mb-3 text-gray-700 ${className || ''}`.trim()}>{children}</h3>;
const P: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => <p className={`mb-4 text-base leading-relaxed ${className || ''}`.trim()}>{children}</p>;
...
const Blockquote: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => <blockquote className={`border-l-4 border-indigo-500 pl-4 italic text-gray-600 my-6 py-2 ${className || ''}`.trim()}>{children}</blockquote>;
const Strong: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => <strong className={`font-bold text-gray-900 ${className || ''}`.trim()}>{children}</strong>;
const Input: React.FC<React.InputHTMLAttributes<HTMLInputElement>> = ({ className, ...props }) => <input {...props} className={`w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition bg-white text-gray-900 ${className || ''}`} />;
const Textarea: React.FC<React.TextareaHTMLAttributes<HTMLTextAreaElement>> = ({ className, ...props }) => <textarea {...props} rows={2} className={`w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition bg-white text-gray-900 ${className || ''}`} />;
const Checkbox: React.FC<React.InputHTMLAttributes<HTMLInputElement>> = ({ className, ...props }) => <input type="checkbox" {...props} className={`h-5 w-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer bg-white ${className || ''}`} />;
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div className="space-y-1">
                            <label className="text-sm font-medium text-gray-700">Método/Dica 1 e Porquê:</label>
                            <Textarea name="c0_method1" value={formData.c0_method1 || ''} onChange={handleInputChange} />
                        </div>
                         <div className="space-y-1">
                            <label className="text-sm font-medium text-gray-700">Método/Dica 2 e Porquê:</label>
                            <Textarea name="c0_method2" value={formData.c0_method2 || ''} onChange={handleInputChange} />
                        </div>
                         <div className="space-y-1">
                            <label className="text-sm font-medium text-gray-700">Método/Dica 3 e Porquê:</label>
                            <Textarea name="c0_method3" value={formData.c0_method3 || ''} onChange={handleInputChange} />
                        </div>
                    </div>
                    <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Dica: Pense em rotinas matinais rígidas, sistemas de organização complexos, apps que você abandonou, etc.</P>
                </div>
            </div>
            {/* Item 2 */}
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Imprevisto:</label>
                            <Input name="c0_unexpected_event" value={formData.c0_unexpected_event || ''} onChange={handleInputChange} />
                        </div>
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Reação:</label>
                             <Input name="c0_reaction" value={formData.c0_reaction || ''} onChange={handleInputChange} />
                        </div>
                    </div>
                    <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Dica: Pode ser uma demanda urgente, um problema técnico, uma questão pessoal, etc.</P>
                </div>
            </div>
            {/* Item 3 */}
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Mudança Urgente:</label>
                        <Textarea name="c0_urgent_change" value={formData.c0_urgent_change || ''} onChange={handleInputChange} />
                    </div>
                    <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Dica: Seja específico! Ex: "Parar de procrastinar tarefas importantes", "Ter mais clareza do que fazer", "Sentir menos culpa no fim do dia", "Lidar melhor com interrupções".</P>
                </div>
            </div>
            {/* Item 4 */}
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Nota (1-10):</label>
                        ...
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Breve comentário (opcional):</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center space-x-2">
                        ...
                        <label htmlFor="c0_commitment" className="text-sm text-gray-700 cursor-pointer">Sim, estou pronto(a)!</label>
                    </div>
                    <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Ação Final Sugerida: Guarde esta página ou suas respostas. Será interessante revisitá-las ao concluir o livro/curso para ver sua evolução!</P>
                </div>
            </div>
        </div>
      </>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Meu Principal Hábito/Medo Perfeccionista:</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Tarefa Escolhida:</label>
                        ...
                        <div className="flex items-center space-x-2 pt-2">
                             ...
                             <label htmlFor="c1_task_done" className="text-sm text-gray-700 cursor-pointer">Tarefa realizada de forma "boa o suficiente"?</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Tarefa Adiada Escolhida:</label>
                        ...
                        <div className="flex items-center space-x-2 pt-2">
                            ...
                            <label htmlFor="c1_5min_rule_done" className="text-sm text-gray-700 cursor-pointer">Trabalhei por 5 minutos?</label>
                        </div>
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">(Opcional) Continuei trabalhando após os 5 min? (Sim/Não)</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Ideia/Projeto:</label>
                             <Input name="c1_mvp_idea" value={formData.c1_mvp_idea || ''} onChange={handleInputChange} />
                        </div>
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Versão Mínima/Feia a Criar Hoje:</label>
                        ...
                        <div className="flex items-center space-x-2 pt-2">
                            ...
                            <label htmlFor="c1_mvp_created" className="text-sm text-gray-700 cursor-pointer">Versão mínima criada?</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Sentimento/Observação:</label>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
            <P>Pegue uma tarefa ou projeto que parece complexo ou que você está adiando por causa disso:</P>
            <div className="space-y-4">
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">1. Liste Todas as Etapas Percebidas:</label>
                    <Textarea name="c1_exercise_all_steps" value={formData.c1_exercise_all_steps || ''} onChange={handleInputChange} rows={3} />
                </div>
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">2. Corte Pela Metade (ou Mais!):</label>
                    <p className="text-xs text-gray-600 !mb-2">O que é *realmente* essencial para o primeiro passo? O que pode ser eliminado, simplificado ou adiado?</p>
                    <Textarea name="c1_exercise_cut_steps" value={formData.c1_exercise_cut_steps || ''} onChange={handleInputChange} rows={3} />
                </div>
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">3. Defina a Ação Mínima Viável:</label>
                     <p className="text-xs text-gray-600 !mb-2">Qual é a menor ação física e concreta que você pode realizar AGORA para iniciar?</p>
                    ...
                    <div className="flex items-center space-x-2 pt-3">
                        ...
                        <label htmlFor="c1_exercise_commit" className="text-sm text-gray-800 font-medium cursor-pointer">Comprometa-se: Realize esta Ação Mínima Viável!</label>
                    </div>
                </div>
            </div>
            
            <div className="border border-gray-200 rounded-lg mt-6">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Exemplo Prático (Criar um Blog):</div>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Situação/Erro:</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Lição Principal Aprendida:</label>
            ...
            <div className="flex items-start">
                <div className="text-2xl mr-4 text-slate-400 select-none">☐</div>
                <div className="flex-1">
                    <p><Strong>3. Reenquadre como Dados (Estilo Edison):</Strong> Complete a frase, aplicando a lição aprendida ao erro que você mapeou: <em className="text-gray-600">"Com [o erro acima], eu não falhei, apenas descobri que/aprendi a..."</em></p>
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">"Com [...], eu não falhei, apenas descobri que/aprendi a [...]"</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Ação/Decisão Adiada:</label>
                            <Input name="c2_procrastinated_action" value={formData.c2_procrastinated_action || ''} onChange={handleInputChange} />
                        </div>
                        <div>
                            <label className="font-semibold text-sm text-gray-700 block mb-1">Medo Específico Associado:</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Micro-Teste/Erro Controlado:</label>
                        <Textarea name="c2_controlled_error" value={formData.c2_controlled_error || ''} onChange={handleInputChange} />
                        <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Dica: Pense em pesquisa antes de lançar, versão beta, pedir feedback em um rascunho, etc.</P>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
            <H3 className="!mt-0 !mb-2 text-indigo-800">Template: Análise de Medo (Fear-Setting)</H3>
            <div className="space-y-4">
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">1. Ação/Decisão que Causa Medo:</label>
                    <Input name="c2_fearsetting_action" value={formData.c2_fearsetting_action || ''} onChange={handleInputChange} />
                </div>
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">2. Definindo o "Fracasso": (Seja concreto!)</label>
                    <Input name="c2_fearsetting_failure" value={formData.c2_fearsetting_failure || ''} onChange={handleInputChange} />
                </div>
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">3. Piores Cenários Possíveis (Brainstorm):</label>
                    <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                        <p className="text-xs text-gray-600 !mb-2">Liste as consequências negativas realistas. Avalie Probabilidade (1-5) e Impacto (1-5).</p>
                ...
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">4. Prevenção:</label>
                    <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                        <p className="text-xs text-gray-600 !mb-2">O que você pode fazer para diminuir a probabilidade dos piores cenários?</p>
                ...
                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">5. Reparo:</label>
                    <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                        <p className="text-xs text-gray-600 !mb-2">Se o pior acontecer, como você pode consertar/mitigar? Quem pode ajudar?</p>
                 ...
                 <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">6. Custo da Inação:</label>
                    <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                        <p className="text-xs text-gray-600 !mb-2">Quais os custos (financeiros, emocionais, oportunidade) de NÃO agir por 6 meses? 1 ano? 3 anos?</p>
                        <Textarea name="c2_fearsetting_inaction_cost" value={formData.c2_fearsetting_inaction_cost || ''} onChange={handleInputChange} />
                    </div>
                </div>
                 <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">7. Decisão Pós-Análise:</label>
                    <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                        <p className="text-xs text-gray-600 !mb-2">O risco de agir (com prevenção/reparo) parece maior ou menor que o custo da inação? Qual o próximo passo?</p>
            ...
            <div className="border border-gray-200 rounded-lg mt-6">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Exemplo Rápido (Apresentar ideia ao chefe):</div>
                <div className="p-4 text-gray-700">
                    <UL className="!mb-0 space-y-3">
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
        <>
            ...
            <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
                <H3 className="!mt-0 !mb-2 text-indigo-800">Template: Desafio do Caos Controlado - Minha Experiência</H3>
                <div className="space-y-4">
                    <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">1. Arena Escolhida: (Qual tarefa ou bloco de tempo?)</label>
                        <Input name="c3_exercise_arena" value={formData.c3_exercise_arena || ''} onChange={handleInputChange} />
                    </div>
                    <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">2. Ritual da Bússola (Pré-Arena):</label>
                        <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                            <div><p className="font-medium text-sm text-gray-700">Prioridade Essencial #1 Definida:</p><Input name="c3_exercise_priority" value={formData.c3_exercise_priority || ''} onChange={handleInputChange} /></div>
                        </div>
                    </div>
                    <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">3. Bloco(s) de Ação Focada (Durante):</label>
                         <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                            <div><p className="font-medium text-sm text-gray-700">Alguma interrupção ou imprevisto significativo?</p><Input name="c3_exercise_interruption" value={formData.c3_exercise_interruption || ''} onChange={handleInputChange} /></div>
                            <div><p className="font-medium text-sm text-gray-700">Usei a mentalidade "Feito &gt; Perfeito"? Como?</p><Input name="c3_exercise_done_is_better" value={formData.c3_exercise_done_is_better || ''} onChange={handleInputChange} /></div>
                        </div>
                    </div>
                    <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">4. Check-in Adaptativo (Durante/Após):</label>
                         <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                            <div><p className="font-medium text-sm text-gray-700">Precisei ajustar minhas prioridades ou plano? Como?</p><Input name="c3_exercise_adjustment" value={formData.c3_exercise_adjustment || ''} onChange={handleInputChange} /></div>
                            <div><p className="font-medium text-sm text-gray-700">Qual foi o maior aprendizado durante a aplicação?</p><Input name="c3_exercise_learning" value={formData.c3_exercise_learning || ''} onChange={handleInputChange} /></div>
                        </div>
                    </div>
                    <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">5. Reflexão Final (Pós-Arena):</label>
                        <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
                            <div><p className="font-medium text-sm text-gray-700">O que funcionou BEM ao aplicar os 3 Passos?</p><Textarea name="c3_exercise_worked_well" value={formData.c3_exercise_worked_well || ''} onChange={handleInputChange} /></div>
                            <div><p className="font-medium text-sm text-gray-700">O que pode ser MELHORADO na próxima vez?</p><Textarea name="c3_exercise_improvement" value={formData.c3_exercise_improvement || ''} onChange={handleInputChange} /></div>
                        </div>
                    </div>
                </div>
            </div>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Meu Alvo para o TAE:</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                <div>
                  <label className="font-semibold text-sm text-gray-700 mb-1 block">Mini-Teste Planejado:</label>
                  <Input name="c4_mini_test_plan" value={formData.c4_mini_test_plan || ''} onChange={handleInputChange} aria-label="Mini-Teste Planejado" />
                </div>
                <div>
                  <label className="font-semibold text-sm text-gray-700 mb-1 block">Objetivo de Aprendizado:</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center space-x-2">
                ...
                <label htmlFor="c4_test_executed" className="text-sm text-gray-700 cursor-pointer">Teste realizado?</label>
              </div>
            </div>
          </div>
          {/* Item 4 */}
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                <div>
                  <label className="font-semibold text-sm text-gray-700 mb-1 block">Aprendizado do Teste:</label>
                  <Input name="c4_test_learning" value={formData.c4_test_learning || ''} onChange={handleInputChange} aria-label="Aprendizado do Teste" />
                </div>
                <div>
                  <label className="font-semibold text-sm text-gray-700 mb-1 block">Ajuste Planejado:</label>
                  <Input name="c4_adjustment_plan" value={formData.c4_adjustment_plan || ''} onChange={handleInputChange} aria-label="Ajuste Planejado" />
                </div>
              </div>
              <P className="text-xs text-gray-500 mt-2 italic">Dica: O ajuste pode ser mudar o horário, simplificar ainda mais, usar outra ferramenta, pedir ajuda, etc.</P>
            </div>
          </div>
          {/* Item 5 */}
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700 block mb-1">Ideia de Escala Futura:</label>
                ...
                <P className="!mb-0 text-xs text-gray-500 mt-2 italic">Ex: Se o teste foi meditar 1 min, o ajuste foi para 2 min, a escala pode ser fazer 5 min consistentemente por uma semana.</P>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
          <H3 className="!mt-0 !mb-2 text-indigo-800">Template: Ciclo de Iteração TAE</H3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="font-semibold text-sm text-gray-700 block mb-1">Projeto/Objetivo:</label>
              <Input name="c4_exercise_project" value={formData.c4_exercise_project || ''} onChange={handleInputChange} aria-label="Projeto/Objetivo" />
            </div>
            <div>
              <label className="font-semibold text-sm text-gray-700 block mb-1">Data de Início:</label>
          ...
          <div className="space-y-4 bg-white/50 p-4 rounded border border-white">
            <h4 className="font-bold text-gray-800">Ciclo 1</h4>
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Teste 1: (Qual foi o menor passo/experimento inicial?)</label>
              <Textarea name="c4_exercise_test1" value={formData.c4_exercise_test1 || ''} onChange={handleInputChange} aria-label="Teste 1" />
            </div>
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Resultado/Aprendizado 1: (O que aconteceu? O que aprendi?)</label>
            ...
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Ajuste 1 Planejado: (Qual pequena mudança farei?)</label>
          ...
          <div className="space-y-4 bg-white/50 p-4 rounded border border-white">
            <h4 className="font-bold text-gray-800">Ciclo 2 (Realizado após o Ajuste 1)</h4>
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Teste 2 (Ajustado): (Qual foi o próximo passo/experimento?)</label>
              <Textarea name="c4_exercise_test2" value={formData.c4_exercise_test2 || ''} onChange={handleInputChange} aria-label="Teste 2" />
            </div>
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Resultado/Aprendizado 2: (O que aconteceu? O que aprendi?)</label>
            ...
            <div>
              <label className="font-medium text-sm text-gray-700 block mb-1">Ajuste 2 Planejado / Ideia de Escala: (Qual a próxima mudança ou como posso escalar um pouco?)</label>
          ...
          <div className="border border-gray-200 rounded-lg mt-6">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Exemplo Prático (Lançar Curso Online):</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0 space-y-3">
                <LI><Strong>Projeto:</Strong> Curso Online sobre X.</LI>
                <LI><Strong>Ciclo 1 - Teste:</Strong> Criar um post no Instagram perguntando o interesse no tema X e quais as maiores dúvidas. <br /><span className="text-sm text-gray-500"><em>Resultado:</em> Alto engajamento, dúvidas A, B, C surgiram.</span> <br /><span className="text-sm text-gray-500"><em>Ajuste:</em> Focar o conteúdo inicial nas dúvidas A e B.</span></LI>
                <LI><Strong>Ciclo 2 - Teste:</Strong> Oferecer uma aula ao vivo gratuita sobre a dúvida A (baixo custo/risco). <br /><span className="text-sm text-gray-500"><em>Resultado:</em> Muitos inscritos, feedback positivo, pessoas perguntaram se haveria curso completo.</span> <br /><span className="text-sm text-gray-500"><em>Ajuste/Escala:</em> Criar uma pré-venda para um mini-curso focado nas dúvidas A, B, C com desconto.</span></LI>
              </UL>
            </div>
          </div>
        </div>
      ...
      <>
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Raízes da Busca pelo Controle:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
          ...
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Custos Ocultos do Controle Rígido:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
          ...
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Reação Cerebral à Falta de Controle:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
          ...
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Como Modular a Reação Cerebral:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Minha Área de Controle Excessivo:</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                  <div>
                    <label className="font-semibold text-sm text-gray-700 mb-1">Minha Micro-Ação de Flexibilidade:</label>
                    <p className="text-xs text-gray-500 !mb-1 italic">Ex: delegar uma pequena decisão, não checar progresso por X horas...</p>
                  ...
                  <div className="flex items-center space-x-2 pt-2">
                    ...
                    <label htmlFor="c5_action_done" className="text-sm text-gray-700 cursor-pointer">Ação realizada?</label>
                  </div>
              </div>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Meu Buffer de ~20% está em:</label>
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="c5_pause_done" className="text-sm text-gray-700 cursor-pointer">Consegui pausar e observar?</label>
                 </div>
                 <div>
                    <label className="font-semibold text-sm text-gray-700 mb-1">(Opcional) Sensação inicial observada:</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Como usei/usaria meu buffer hoje:</label>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
            <H3 className="!mt-0 !mb-2 text-indigo-800">Template: Experiência com Planejamento 80/20</H3>
            
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">Período de Análise: (Ex: Dia DD/MM, Semana X)</label>
                <Input name="c5_exercise_period" value={formData.c5_exercise_period || ''} onChange={handleInputChange} />
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                  <label className="font-semibold text-sm text-gray-700 block mb-1">1. Capacidade Total Estimada (Horas):</label>
                  <Input name="c5_exercise_total_hours" value={formData.c5_exercise_total_hours || ''} onChange={handleInputChange} type="number" />
              </div>
              <div>
                  <label className="font-semibold text-sm text-gray-700 block mb-1">2. Limite de 80% Planejado (Horas):</label>
                  <Input name="c5_exercise_80_limit" value={formData.c5_exercise_80_limit || ''} onChange={handleInputChange} type="number" />
              </div>
            </div>

            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">3. Tarefas/Compromissos Agendados (Dentro dos 80%):</label>
                <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
            ...
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">4. Buffer de 20% Reservado (Onde/Como?):</label>
                <p className="text-xs text-gray-600 !mb-2 italic">Ex: Blocos livres na agenda, estimativas folgadas, "Bloco Flex/Caos"</p>
                <Textarea name="c5_exercise_buffer_reserved" value={formData.c5_exercise_buffer_reserved || ''} onChange={handleInputChange} />
            </div>

            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">5. Como o Buffer Foi Usado (Realidade):</p>
                 <div className="space-y-4 mt-2 bg-white/50 p-3 rounded border border-white">
                    <div>
                        <p className="font-medium text-sm text-gray-700">Imprevistos que surgiram e foram absorvidos:</p>
                        <Textarea name="c5_exercise_buffer_unexpected" value={formData.c5_exercise_buffer_unexpected || ''} onChange={handleInputChange} />
                    </div>
                    <div>
                        <p className="font-medium text-sm text-gray-700">Usei para pausas/reflexão:</p>
             ...
             <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">6. Reflexão Sobre a Experiência:</p>
                 <div className="space-y-4 mt-2 bg-white/50 p-3 rounded border border-white">
                    <div>
                        <p className="font-medium text-sm text-gray-700">Como foi ter essa folga incorporada? (Sensação de estresse, realismo)</p>
                        <Textarea name="c5_exercise_reflection_feeling" value={formData.c5_exercise_reflection_feeling || ''} onChange={handleInputChange} />
                    </div>
                    <div>
                        <p className="font-medium text-sm text-gray-700">Qual o impacto na sensação de controle (paradoxalmente) e produtividade real?</p>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Os 5 Pilares da Autoridade Autêntica:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
          ...
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">A Ciência da Conexão com Falhas Superadas:</div>
            <div className="p-4 text-gray-700">
              <UL className="!mb-0">
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Lição Principal (do Erro X):</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                <label className="font-semibold text-sm text-gray-700">Público-Alvo para esta Lição:</label>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg text-sm">Estrutura Sugerida:</div>
                <div className="p-4 text-gray-700">
                  <UL className="!mb-4">
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                <div className="flex items-center space-x-2"><Checkbox name="c6_ethics_check1" id="c6_ethics_check1" checked={!!formData.c6_ethics_check1} onChange={handleInputChange} /><label htmlFor="c6_ethics_check1" className="text-sm">Minha intenção principal é <Strong className="text-gray-800">ajudar/conectar/ensinar</Strong>.</label></div>
                <div className="flex items-center space-x-2"><Checkbox name="c6_ethics_check2" id="c6_ethics_check2" checked={!!formData.c6_ethics_check2} onChange={handleInputChange} /><label htmlFor="c6_ethics_check2" className="text-sm">A história foca no <Strong className="text-gray-800">meu aprendizado e na lição aplicável</Strong>.</label></div>
                <div className="flex items-center space-x-2 pt-2"><Checkbox name="c6_ethics_check3" id="c6_ethics_check3" checked={!!formData.c6_ethics_check3} onChange={handleInputChange} /><label htmlFor="c6_ethics_check3" className="text-sm text-gray-700">Estou sendo respeitoso(a) com outras pessoas envolvidas?</label></div>
              </div>
            </div>
          </div>
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                  <div>
                    <label className="font-semibold text-sm text-gray-700 mb-1">Minha Ação de Compartilhamento Inicial:</label>
                    <p className="text-xs text-gray-500 !mb-1 italic">Ex: Contar para UM amigo, escrever um post curto, mencionar em uma reunião.</p>
                  ...
                  <div className="flex items-center space-x-2 pt-2">
                    ...
                    <label htmlFor="c6_action_done" className="text-sm text-gray-700 cursor-pointer">Ação realizada?</label>
                  </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-indigo-50 p-4 sm:p-6 rounded-lg border border-indigo-200 space-y-4">
          <H3 className="!mt-0 !mb-2 text-indigo-800">Template: Meu Banco de Histórias MPC</H3>
          <P className="text-sm text-indigo-700 !mb-4">Use este banco para mapear 2-3 histórias. Volte aqui sempre que superar um novo desafio significativo para adicionar ao seu repertório.</P>
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-indigo-200 rounded-lg text-sm">
              <thead className="bg-indigo-100">
                <tr>
                  <th className="p-3 font-semibold text-left text-indigo-900">Erro/Desafio</th>
                  <th className="p-3 font-semibold text-left text-indigo-900">Lição Principal</th>
                  <th className="p-3 font-semibold text-left text-indigo-900">Público Ideal</th>
                  <th className="p-3 font-semibold text-left text-indigo-900">Status</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-t border-indigo-200 bg-gray-50/50">
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">O que é?</div>
                <div className="p-4 text-gray-700">
                    <UL className="!mb-0">
            ...
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Por que é crucial na Produtividade Caótica?</div>
                <div className="p-4 text-gray-700">
                     <UL className="!mb-0">
            ...
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">O Cérebro como "Filtro 80/20" (e como ajudá-lo):</div>
                <div className="p-4 text-gray-700">
                     <UL className="!mb-0">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>1. Faça a Pergunta 80/20 AGORA:</Strong> Olhe para sua lista de tarefas de hoje (ou para o que você <em>acha</em> que precisa fazer). Pergunte-se: <Strong>"Quais 1-3 tarefas aqui provavelmente gerarão 80% do valor ou progresso real do dia?"</Strong></p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Meus ~20% Vitais de Hoje:</label>
             ...
             <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>2. Identifique 1 Item Trivial para Eliminar/Reduzir:</Strong> Olhe para o resto da sua lista ou para suas atividades habituais. Qual é UMA tarefa ou atividade que consome tempo/energia mas gera <Strong>pouco valor real</Strong>?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Item Trivial Identificado:</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>3. Decida a Ação sobre o Trivial:</Strong> Para o item trivial acima, escolha UMA ação IMEDIATA:</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <P className="!mb-0 text-sm text-gray-600 bg-gray-100 p-2 rounded">Opções: Eliminar Completamente / Reduzir Frequência/Duração / Delegar / Automatizar</P>
                        <div>
                            <label className="font-semibold text-sm text-gray-700 mb-1">Ação Específica:</label>
                            <p className="text-xs text-gray-500 !mb-1 italic">Ex: "Não fazer X hoje", "Checar e-mail só 2x", "Pedir para Y fazer Z", "Criar template para W"</p>
                        ...
                        <div className="flex items-center space-x-2 pt-2">
                          ...
                          <label htmlFor="c7_action_taken" className="text-sm text-gray-700 cursor-pointer">Decisão/Ação tomada?</label>
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>4. Proteja o Vital:</Strong> Como você pode garantir que dedicará seu <Strong>melhor tempo e energia</Strong> à sua tarefa vital #1 identificada no item 1?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Estratégia para Proteger o Vital #1:</label>
             ...
             <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>5. Questione uma Fonte de Informação:</Strong> Pense nas suas fontes de informação (e-mails, redes sociais, notícias, reuniões). Qual delas parece consumir muito tempo para pouco insight útil?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Fonte Trivial e Ação de Redução:</label>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
            <H3 className="!mt-0 !mb-0 text-indigo-800">Template: Análise 80/20 Pessoal</H3>
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">1. Arena de Análise:</label>
                 <p className="text-xs text-gray-600 !mb-2">Qual área específica você vai analisar? Ex: Tarefas da última semana, Fontes de estresse, Clientes do negócio, Uso do tempo livre</p>
                <Input name="c7_exercise_arena" value={formData.c7_exercise_arena || ''} onChange={handleInputChange} />
            </div>
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">2. Liste os Componentes e 3. Avalie o Impacto:</label>
                <P className="text-xs text-gray-600 !mb-2">Liste os itens e estime o impacto de cada um (Positivo ou Negativo: Baixo, Médio, Alto).</P>
                <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
            ...
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">4. Identifique os ~20% Vitais e 5. Identifique os ~80% Triviais:</label>
                 <P className="text-xs text-gray-600 !mb-2">Com base na sua avaliação, destaque os itens de alto impacto (vitais) e os de baixo impacto/alto custo (triviais).</P>
            ...
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">6. Plano de Ação 80/20:</label>
                 <div className="space-y-4 mt-2 bg-white/50 p-3 rounded border border-white">
                    <div>
                        <p className="font-medium text-sm text-gray-700">Amplificar os 20%:</p>
                        <p className="text-xs text-gray-500 !mb-1 italic">Qual a primeira ação para dedicar MAIS foco a UM item vital?</p>
                        <Input name="c7_exercise_amplify" value={formData.c7_exercise_amplify || ''} onChange={handleInputChange} />
                    </div>
                    <div>
                        <p className="font-medium text-sm text-gray-700">Reduzir/Eliminar os 80%:</p>
                        <p className="text-xs text-gray-500 !mb-1 italic">Qual o item trivial mais fácil de eliminar/reduzir imediatamente? Qual a ação?</p>
            ...
            <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="c7_exercise_commit_amplify" className="text-sm text-gray-700 font-medium cursor-pointer">Compromisso: Amplificar</label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="c7_exercise_commit_reduce" className="text-sm text-gray-700 font-medium cursor-pointer">Compromisso: Reduzir</label>
                </div>
            </div>
        </div>
      </>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">A Tríade de Taleb:</div>
                <div className="p-4 text-gray-700">
                    <UL className="!mb-0">
            ...
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Por que buscar Antifragilidade (e não só Resiliência)?</div>
                <div className="p-4 text-gray-700">
                     <UL className="!mb-0">
            ...
            <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Conexão com a Produtividade Caótica:</div>
                <div className="p-4 text-gray-700">
             ...
             <div className="border border-gray-200 rounded-lg">
                <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Exemplos na Natureza e Ciência:</div>
                <div className="p-4 text-gray-700">
                     <UL className="!mb-0">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>1. Identifique sua MAIOR Fragilidade Atual:</Strong> Pense em seu trabalho, negócio ou projeto principal. Qual é o <Strong>ponto mais vulnerável</Strong> a um choque inesperado, erro ou mudança de cenário?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Minha Principal Fragilidade:</label>
             ...
             <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>2. Aplique a Estratégia Barbell (Micro-Ação):</Strong> Para equilibrar segurança e oportunidade:</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                        <div>
                            <label className="font-semibold text-sm text-gray-700 mb-1">(Segurança) Ação para Robustecer Área Crítica:</label>
                            <div className="flex items-center space-x-2">
                        ...
                        <div>
                            <label className="font-semibold text-sm text-gray-700 mb-1">(Oportunidade/TAE) Pequena "Aposta" de Baixo Risco:</label>
                             <div className="flex items-center space-x-2">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>3. Crie Opcionalidade (Ideia):</Strong> Pense em UMA maneira de aumentar suas opções e reduzir dependências no futuro.</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Ideia para Criar Opcionalidade:</label>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>4. Transforme um Problema em Oportunidade:</Strong> Olhe para um problema, erro ou desafio RECENTE. Como você poderia <Strong>extrair valor</Strong> disso?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Problema -&gt; Oportunidade/Aprendizado Estratégico:</label>
             ...
             <div className="flex items-start">
                ...
                <div className="flex-1">
                    <p><Strong>5. Simplifique para Robustecer:</Strong> Identifique UM processo, ferramenta ou sistema em seu trabalho que seja <Strong>complexo demais e propenso a falhas</Strong>. Qual a forma MAIS SIMPLES de realizar a mesma função essencial?</p>
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Processo Complexo -&gt; Ação de Simplificação:</label>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
            <H3 className="!mt-0 !mb-0 text-indigo-800">Template: Análise Antifrágil de um Desafio</H3>
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">1. Desafio/Fragilidade Atual:</label>
                <Textarea name="c8_exercise_challenge" value={formData.c8_exercise_challenge || ''} onChange={handleInputChange} />
            </div>
             <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">2. Análise de Risco (Mentalidade TAE/Barbell):</label>
                <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
            ...
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">3. Geração de Opcionalidade:</label>
                 <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
             ...
             <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">4. Transformando o Problema em Vantagem (Pensamento Antifrágil Central):</label>
                 <div className="space-y-2 mt-2 bg-white/50 p-3 rounded border border-white">
            ...
            <div>
                <label className="font-semibold text-sm text-gray-700 block mb-1">5. Ação Antifrágil Imediata (TAE!):</label>
                <P className="text-xs text-gray-600 !mb-2">Qual o menor passo concreto que posso dar nos próximos dias para testar uma solução de baixo risco OU começar a construir opcionalidade?</P>
                <div className="flex items-center space-x-3">
                    <Input name="c8_exercise_immediate_action" value={formData.c8_exercise_immediate_action || ''} onChange={handleInputChange} className="flex-1" />
                     <div className="flex items-center space-x-2">
                        ...
                        <label htmlFor="c8_exercise_action_done" className="text-sm text-gray-700 font-medium cursor-pointer">Feito!</label>
                     </div>
                </div>
            </div>
        </div>
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <div className="space-y-4">
          {/* Day 1 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 1: Mapeando Seu Caos Pessoal</div>
            <div className="p-4 text-gray-700 space-y-4">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                <label className="font-semibold text-sm text-gray-700">Registro Dia 1:</label>
                <div>
                  <label className="text-sm font-medium text-gray-600 block mb-1">Imprevistos/Interrupções:</label>
                  <Textarea name="c9_d1_interruptions" value={formData.c9_d1_interruptions || ''} onChange={handleInputChange} />
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600 block mb-1">Tarefa Drenadora/Ineficaz:</label>
                  <Textarea name="c9_d1_draining_task" value={formData.c9_d1_draining_task || ''} onChange={handleInputChange} />
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600 block mb-1">Momento de Perda de Foco:</label>
          ...
          {/* Day 2 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 2: Criando Seu Mapa de Fracassos Estratégicos</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 2:</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Erro/Falha:</label><Input name="c9_d2_error" value={formData.c9_d2_error || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Causa Raiz:</label><Input name="c9_d2_root_cause" value={formData.c9_d2_root_cause || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Lição Principal:</label><Input name="c9_d2_lesson" value={formData.c9_d2_lesson || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Aplicação Hoje/Semana:</label><Input name="c9_d2_application" value={formData.c9_d2_application || ''} onChange={handleInputChange} /></div>
              </div>
          ...
          {/* Day 3 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 3: Testando o "Pior Cenário Simulado" (Fear-Setting)</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <UL className="!mb-0">
               ...
               <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 3:</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Ação/Decisão com Medo:</label><Input name="c9_d3_fear_action" value={formData.c9_d3_fear_action || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Pior Cenário Realista Principal:</label><Input name="c9_d3_worst_case" value={formData.c9_d3_worst_case || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">1 Ação de Prevenção Chave:</label><Input name="c9_d3_prevention" value={formData.c9_d3_prevention || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">1 Ação de Reparo Chave:</label><Input name="c9_d3_repair" value={formData.c9_d3_repair || ''} onChange={handleInputChange} /></div>
              </div>
          ...
          {/* Day 4 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 4: Experimentando um "Erro Controlado" (TAE na Prática)</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <UL className="!mb-0">
                ...
                <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 4:</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Ideia/Mudança Testada:</label><Input name="c9_d4_idea" value={formData.c9_d4_idea || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Mini-Teste Realizado:</label><Input name="c9_d4_test" value={formData.c9_d4_test || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Resultado/Aprendizado Imediato:</label><Input name="c9_d4_result" value={formData.c9_d4_result || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Ajuste Planejado:</label><Input name="c9_d4_adjustment" value={formData.c9_d4_adjustment || ''} onChange={handleInputChange} /></div>
              </div>
          ...
          {/* Day 5 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 5: Criando Seu Ritual de Ancoragem no Caos</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <P className="!mb-0"><Strong>Missão Hoje:</Strong> Desenhe seu "botão de pausa" pessoal - um ritual de 1-3 minutos para se recentrar em momentos de estresse ou sobrecarga. Escolha 2-3 técnicas simples que funcionam para VOCÊ (respiração, movimento rápido, mantra, focar nos sentidos, revisar prioridade #1, etc.). Pratique seu ritual pelo menos UMA VEZ hoje, mesmo sem crise.</P>
               <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 5 (Meu Ritual):</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Técnica 1 Escolhida:</label><Input name="c9_d5_tech1" value={formData.c9_d5_tech1 || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Técnica 2 Escolhida:</label><Input name="c9_d5_tech2" value={formData.c9_d5_tech2 || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Sequência Rápida:</label><Input name="c9_d5_sequence" value={formData.c9_d5_sequence || ''} onChange={handleInputChange} /></div>
                <div className="flex items-center space-x-2">
                  <Checkbox name="c9_d5_practiced" id="c9_d5_practiced" checked={!!formData.c9_d5_practiced} onChange={handleInputChange} />
                  <label htmlFor="c9_d5_practiced" className="text-sm text-gray-700 cursor-pointer">Pratiquei Hoje?</label>
                </div>
              </div>
          ...
          {/* Day 6 */}
           <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 6: Automatizando ou Delegando Algo Pequeno</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 6 (Ação 80/20):</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Tarefa Trivial Identificada:</label><Input name="c9_d6_trivial_task" value={formData.c9_d6_trivial_task || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Ação Escolhida (Automatizar/Delegar/Parar):</label><Input name="c9_d6_action" value={formData.c9_d6_action || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Plano/Execução da Ação Hoje:</label><Input name="c9_d6_plan" value={formData.c9_d6_plan || ''} onChange={handleInputChange} /></div>
                <div className="flex items-center space-x-2">
                  <Checkbox name="c9_d6_done" id="c9_d6_done" checked={!!formData.c9_d6_done} onChange={handleInputChange} />
                  <label htmlFor="c9_d6_done" className="text-sm text-gray-700 cursor-pointer">Ação Realizada?</label>
                </div>
              </div>
          ...
          {/* Day 7 */}
          <div className="border border-gray-200 rounded-lg">
            <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">Dia 7: Fazendo Seu "Relatório de Vulnerabilidade" (Reflexão Final)</div>
             <div className="p-4 text-gray-700 space-y-4">
              ...
              <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-3">
                 <label className="font-semibold text-sm text-gray-700">Registro Dia 7 (Relatório de Vulnerabilidade):</label>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Maior Sucesso / O que funcionou melhor nesta semana?</label><Textarea name="c9_d7_success" value={formData.c9_d7_success || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Maior Dificuldade / Onde "falhei" ou escorreguei?</label><Textarea name="c9_d7_difficulty" value={formData.c9_d7_difficulty || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Principal Insight / Surpresa da Semana?</label><Textarea name="c9_d7_insight" value={formData.c9_d7_insight || ''} onChange={handleInputChange} /></div>
                <div><label className="text-sm font-medium text-gray-600 block mb-1">Meu Compromisso para Continuar:</label><Textarea name="c9_d7_commitment" value={formData.c9_d7_commitment || ''} onChange={handleInputChange} /></div>
              </div>
  ...
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
        <>
            ...
            <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">1. Aceite o Caos, Não Lute Contra Ele:</div>
                    <div className="p-4 text-gray-700">Abrace incerteza e imprevisibilidade como normais. Pare de gastar energia no controle impossível.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">2. Busque Progresso, Abandone a Perfeição:</div>
                    <div className="p-4 text-gray-700">Ação imperfeita e consistente &gt; busca paralisante pela perfeição. "Feito" é (geralmente) melhor.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">3. Veja o Erro Como Feedback Valioso:</div>
                    <div className="p-4 text-gray-700">Falhas contêm informações cruciais. Extraia o aprendizado e ajuste a rota, sem culpa.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">4. Cultive a Flexibilidade Acima da Rigidez:</div>
                    <div className="p-4 text-gray-700">Sua capacidade de adaptar-se às mudanças é mais importante que a perfeição do plano inicial.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">5. Foque no Vital (80/20), Ignore o Trivial:</div>
                    <div className="p-4 text-gray-700">Nem tudo importa igual. Concentre energia nos 20% que geram 80% dos resultados. Elimine/minimize o resto.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">6. Comece Pequeno, Aprenda Rápido (TAE):</div>
                    <div className="p-4 text-gray-700">Use experimentação (Teste, Ajuste, Escale) para lidar com incerteza e fazer progressos incrementais.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">7. Abrace a Simplicidade Robusta:</div>
                    <div className="p-4 text-gray-700">Sistemas simples são mais resilientes e adaptáveis no caos do que os complexos. Menos é mais eficaz.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">8. Gerencie Sua Energia, Não Apenas Seu Tempo:</div>
                    <div className="p-4 text-gray-700">Reconheça flutuações de energia (física/mental/emocional) e ajuste seu trabalho/expectativas.</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">9. Construa Antifragilidade (Opções + Resiliência+):</div>
                    <div className="p-4 text-gray-700">Vá além de resistir. Busque formas de se fortalecer <em>com</em> o caos (opções, aprendizado com estressores).</div>
                </div>
                <div className="border border-gray-200 rounded-lg">
                    <div className="bg-gray-50 px-4 py-3 font-semibold text-gray-800 rounded-t-lg">10. Aja Agora, Não Espere o Momento Ideal:</div>
                    <div className="p-4 text-gray-700">Clareza vem da ação. Dê o próximo passo possível, mesmo que pequeno e imperfeito.</div>
                </div>
            </div>
            ...
            <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
                ...
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-3 border-l-2 border-slate-300 pl-4 py-2 bg-slate-100/50 rounded">
                             <p className="font-semibold text-sm text-gray-600 mb-2">Perguntas Guias:</p>
                        ...
                        <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                            <label className="font-semibold text-sm text-gray-700">Meus Insights Chave:</label>
                ...
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                         ...
                         <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                            <label className="font-semibold text-sm text-gray-700">Minhas Ferramentas MPC Foco:</label>
                            <Textarea name="c10_core_tools" value={formData.c10_core_tools || ''} onChange={handleInputChange} />
                            <p className="text-xs text-gray-500 mt-2 italic">Ex: Ritual da Bússola, TAE para projetos novos, Análise 80/20 semanal</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                         ...
                         <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-2">
                            <div>
                                <label className="font-semibold text-sm text-gray-700">Adaptação da Ferramenta 1:</label>
                                <Input name="c10_tool1_adaptation" value={formData.c10_tool1_adaptation || ''} onChange={handleInputChange} />
                            </div>
                             <div>
                                <label className="font-semibold text-sm text-gray-700">Adaptação da Ferramenta 2:</label>
                                <Input name="c10_tool2_adaptation" value={formData.c10_tool2_adaptation || ''} onChange={handleInputChange} />
                            </div>
                             <div>
                                <label className="font-semibold text-sm text-gray-700">Adaptação da Ferramenta 3 (se houver):</label>
                                <Input name="c10_tool3_adaptation" value={formData.c10_tool3_adaptation || ''} onChange={handleInputChange} />
                            </div>
                            <p className="text-xs text-gray-500 mt-2 italic pt-2">Ex: "Fazer Ritual da Bússola à noite", "Usar Blocos de Foco de 45min", "Aplicar 80/20 só mensalmente no início"</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Item 4 */}
                 <div className="flex items-start">
                    ...
                    <div className="flex-1">
                         ...
                         <div className="mt-3 p-3 bg-white border border-dashed rounded-md space-y-2">
                            <div>
                                <label className="font-semibold text-sm text-gray-700">Integração com Ferramenta X:</label>
                                <Input name="c10_integration_x" value={formData.c10_integration_x || ''} onChange={handleInputChange} />
                            </div>
                             <div>
                                <label className="font-semibold text-sm text-gray-700">Integração com Ferramenta Y:</label>
                ...
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                         ...
                         <div className="mt-2 flex items-center space-x-2">
                            ...
                            <label htmlFor="c10_review_scheduled" className="text-sm text-gray-700 cursor-pointer">Lembrete de revisão agendado?</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200 space-y-6">
                <H3 className="!mt-0 !mb-0 text-indigo-800">Template: Meu Plano de Ação MPC - 30 Dias</H3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div>
                        <label className="font-semibold text-sm text-gray-700 block mb-1">Data de Fim (Revisão):</label>
                        <Input name="c10_plan_end_date" value={formData.c10_plan_end_date || ''} onChange={handleInputChange} type="date" />
                    </div>
                </div>

                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">1. Meu Foco Principal MPC (Menos é Mais!):</label>
                    <Textarea name="c10_plan_main_focus" value={formData.c10_plan_main_focus || ''} onChange={handleInputChange} />
                    <p className="text-xs text-gray-500 mt-2 italic">Com base no Checklist acima e na sua reflexão do Bootcamp, qual UM insight, técnica ou mudança de mentalidade trará o MAIOR impacto positivo se praticado consistentemente por 30 dias?</p>
                </div>

                 <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">2. Ações Mínimas e Concretas (Estilo TAE):</label>
                     <Textarea name="c10_plan_min_actions" value={formData.c10_plan_min_actions || ''} onChange={handleInputChange} rows={3} />
                    <p className="text-xs text-gray-500 mt-2 italic">Quais ações PEQUENAS, específicas e realistas você se compromete a fazer DIARIAMENTE ou SEMANALMENTE para praticar esse foco?</p>
                </div>

                 <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">3. Sistema de Lembrete/Responsabilidade Simples:</label>
                    <Textarea name="c10_plan_reminder_system" value={formData.c10_plan_reminder_system || ''} onChange={handleInputChange} />
                    <p className="text-xs text-gray-500 mt-2 italic">Como você vai se lembrar de fazer essas ações? Como vai acompanhar o progresso - mesmo que imperfeito? Mantenha SIMPLES!</p>
                </div>

                 <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">4. Antecipando Obstáculos (Mentalidade Antifrágil):</label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                             <label className="font-semibold text-sm text-gray-700">Obstáculo Provável:</label>
                             <Textarea name="c10_plan_obstacle" value={formData.c10_plan_obstacle || ''} onChange={handleInputChange} />
                             <p className="text-xs text-gray-500 mt-1 italic">Ex: "Falta de tempo/cansaço", "Esquecer de fazer", "Voltar ao modo antigo"</p>
                        </div>
                        <div>
                             <label className="font-semibold text-sm text-gray-700">Minha Estratégia MPC para Lidar:</label>
                             <Textarea name="c10_plan_strategy" value={formData.c10_plan_strategy || ''} onChange={handleInputChange} />
                             <p className="text-xs text-gray-500 mt-1 italic">Ex: "Fazer versão de 1 min da Bússola", "Se falhar um dia, voltar no seguinte sem culpa - TAE!", "Revisar o 'porquê' do meu foco"</p>
                        </div>
                    </div>
                </div>

                <div>
                    <label className="font-semibold text-sm text-gray-700 block mb-1">5. Revisão em 30 Dias:</label>
                     <Textarea name="c10_plan_30day_review" value={formData.c10_plan_30day_review || ''} onChange={handleInputChange} />
                    <p className="text-xs text-gray-500 mt-2 italic">O que funcionou? O que não funcionou? Qual o próximo foco?</p>
                </div>
            </div>
        </>
    ),
  },
  {
    ...
    content: ({ formData, handleInputChange }) => (
      <>
        ...
        <P className="text-sm text-gray-600 mb-6 italic">Foco em ações super pequenas e imediatas para criar momentum AGORA</P>
        ...
        <div className="space-y-6 bg-slate-50 p-6 rounded-lg border border-slate-200">
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Minha Micro-Ação Imediata Escolhida:</label>
                        <Input name="c11_micro_action" value={formData.c11_micro_action || ''} onChange={handleInputChange} />
                        <p className="text-xs text-gray-500 mt-2 italic">Ex: Fazer 1 min de respiração Box Breathing, definir a Prioridade #1 de amanhã, deletar UM app inútil, fazer 5 min da Regra dos 5 Minutos em algo adiado, escrever UM parágrafo "imperfeito", enviar UM e-mail que estava revisando demais.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center space-x-2">
                      ...
                      <label htmlFor="c11_action_done" className="text-sm text-gray-700 cursor-pointer">Micro-ação realizada?</label>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center space-x-2">
                      ...
                      <label htmlFor="c11_declaration_done" className="text-sm text-gray-700 cursor-pointer">Declaração feita.</label>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                     ...
                     <div className="mt-2 flex items-center space-x-2">
                       ...
                       <label htmlFor="c11_sharing_done" className="text-sm text-gray-700 cursor-pointer">Micro-compartilhamento feito/intencionado?</label>
                     </div>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="flex-1">
                     ...
                     <div className="mt-3 p-3 bg-white border border-dashed rounded-md">
                        <label className="font-semibold text-sm text-gray-700">Prioridade #1 de Amanhã:</label>
                    ...
                    <div className="mt-2 flex items-center space-x-2">
                      ...
                      <label htmlFor="c11_priority_written" className="text-sm text-gray-700 cursor-pointer">Prioridade anotada?</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <Blockquote className="mt-12 text-center text-lg !border-indigo-500 !border-l-4 !border-r-0 !border-y-0 italic text-gray-700 font-medium">
